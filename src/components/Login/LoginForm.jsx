...
function LoginForm() {
    return (
        <div className=" flex flex-col 2xl:gap-[38px] md:gap-[26.98px] 2xl:p-[52px] md:p-[36.92px] md:w-[29rem] 2xl:w-[40.75rem] h-auto 2xl:rounded-[20px] md:rounded-[14.2px] kb-shadow-white-bg ">
            ...
            <form className="flex 2xl:h-[31.5rem] md:h-[22.4rem] flex-col items-center 2xl:gap-[2.125rem] md:gap-[1.51rem] self-stretch">
                ...
                <div className="flex flex-col justify-end items-start 2xl:gap-3 md:gap-2 self-stretch">
                    ...
                    <input className="flex 2xl:h-12 md:h-9 items-center 2xl:gap-1 md:gap-[2.84px] self-stretch 2xl:p-4 md:p-[2.84px] border 2xl:rounded-lg md:rounded-[5.68px] border-solid border-[#CBD2E0]" type="text" />
                </div>
