        ...
        <>
...

            {
                (searchData?.length === 0 && !isLoading)
                    ? <h2 className="p-7 md:min-h-[476px] 2xl:min-h-[787px] max-h-full">No result with key word : {keyWord?.length > 35 ? keyWord.slice(0, 35) + '...' : keyWord}, Please try with the others </h2>
